/**
 * Shared crop visual language — field colours and plant morphology used by the
 * digital twin, the planning flow and the plan sheet, so a crop always looks
 * like itself across the product. Deliberately no emoji: emoji cannot take the
 * palette and is the single strongest "farming game" tell (brief §33).
