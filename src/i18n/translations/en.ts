export const en = {
  ...
  sentinel: {
    ...
    step4Title: 'Check Farm Risk',
    step4Desc: 'Checking whether current costs, returns and risks have changed.',
    step5Title: 'Make Decision',
    step5Desc: 'Combining all the information to decide what should happen next.',
    ...
    // Decision Card
    decisionCardTitle: 'Your Farm Decision',
    ...
    stateNoActionHeadline: 'Your farm is in a good position.',
    stateNoActionDesc: 'Your current crop plan is suitable for the conditions checked today.',
    stateNoActionNext: 'Continue with your current plan.',
    ...
    stateActionHeadline: 'Field adjustment recommended for your crops.',
    stateActionDesc: 'Soil moisture is lower than optimal and little rain is forecast in the coming days.',
    stateActionNext: 'Plan irrigation for tomorrow morning.',
    ...
    stateChangePlanNext: 'Reduce or postpone scheduled irrigation.',
    ...
    stateHighRiskNext: 'Review irrigation and apply crop protection measures.',
    ...
    tellAgentTitle: 'Tell the Agent',
    tellAgentSubtitle: 'Did you notice anything unusual on your farm?',
    tellAgentHelp: 'You can tell the agent something that may not be visible in the farm data.',
    tabSpeak: 'Speak',
    tabType: 'Type',
    tabPhoto: 'Add Photo',
    quickTellHeading: 'Quickly tell us:',
    ...
    chipOther: 'Other',
    typePlaceholder: 'Example: My tomato leaves are turning yellow...',
    addToFarmCheckBtn: 'Add to Farm Check',
    removeObservationBtn: 'Clear Observation',
    observationAddedBadge: 'Farmer observation added ✓',
    reevaluatingMsg: 'Re-checking your farm with this information...',
    ...
    farmerObsDecisionNote: 'Your farm data looks stable, but you reported: ',
